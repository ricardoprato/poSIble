    ...
    <section class="text-white bg-darkBlue">
      <div class="px-4 py-16 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
        <div class="max-w-lg mx-auto text-center">
          <h2 class="text-3xl text-secondary font-bold sm:text-4xl">
            Plataformas
          </h2>
        ...
        <div class="mt-12 text-center">
          <NavLink to="/form">
            <a class="inline-flex items-center px-8 py-3 mt-8 text-black bg-secondary border-2 border-black rounded hover:bg-transparent hover:border-white hover:text-white active:text-secondary focus:outline-none focus:ring">
