    ...
    return (
        <footer className="text-white bg-black lg:grid lg:grid-cols-5">
            <aside className="hidden lg:relative lg:col-span-2 lg:block">
                <img
                    className="absolute inset-o object-cover w-full h-full"
                    src={estudiante}
                    alt="Comic Graphic"
                />
            </aside>
                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                    <div>
                        <p className="font-medium">
                            ...
                            <NavLink to='/' className="block text-2xl sm:text-3xl text-primary hover:text-yellow">
                                poSíble
                            </NavLink>
                        </p>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            <p className="font-medium">Proyecto creado por:</p>

                            <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-300">
                                <a className="hover:opacity-75" href=""> Alberto </a>
                                <a className="hover:opacity-75" href=""> Belen </a>
