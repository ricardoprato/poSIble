      ...
      <div className="relative max-w-screen-xl px-4 py-32 mx-auto lg:h-screen lg:items-center lg:flex">
        <div className="max-w-xl text-center sm:text-left sm:mx-auto">
          ...
          <div className="inline-flex items-center justify-center flex-wrap gap-4 mt-8 mb-8 text-center">
            <NavLink to='/form' className="block w-full px-12 py-3 text-md font-medium text-black rounded shadow bg-primary border-2 border-black sm:w-auto active:bg-rose-500 hover:bg-red focus:outline-none focus:ring">
              Registrarte
            </NavLink>
            <NavLink to='/estudiantes' className="block w-full px-12 py-3 text-md font-medium text-black rounded shadow bg-secondary border-2 border-black sm:w-auto active:bg-rose-500 hover:bg-red focus:outline-none focus:ring">
              Proyecto
            </NavLink>
          </div>
        </div>
